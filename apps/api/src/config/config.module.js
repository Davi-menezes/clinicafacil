...
var bullmq_service_1 = require("./bullmq.service");
var ConfigModule = exports.ConfigModule = function () {
    var _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            providers: [redis_service_1.RedisService, bullmq_service_1.BullMQService],
            exports: [redis_service_1.RedisService, bullmq_service_1.BullMQService],
        })];
