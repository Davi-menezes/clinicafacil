...
var SearchController = exports.SearchController = function () {
    var _classDecorators = [(0, common_1.Controller)('busca')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _buscarProfissionais_decorators;
    var SearchController = _classThis = /** @class */ (function () {
        ...
        SearchController_1.prototype.buscarProfissionais = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.searchService.buscar({
    ...
    (function () {
        _buscarProfissionais_decorators = [(0, common_1.Get)('profissionais'), (0, common_1.UseGuards)(jwt_auth_guard_1.OptionalJwtGuard)];
        __esDecorate(_classThis, null, _buscarProfissionais_decorators, { kind: "method", name: "buscarProfissionais", static: false, private: false, access: { has: function (obj) { return "buscarProfissionais" in obj; }, get: function (obj) { return obj.buscarProfissionais; } } }, null, _instanceExtraInitializers);
