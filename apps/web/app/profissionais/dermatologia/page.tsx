...
export const metadata: Metadata = {
  title: 'Dermatologistas — Encontre os melhores | ClinicaFácil',
  description: 'Cuidados com a pele, cabelos e unhas. Dermatologistas com CRM validado. Online e presencial.',
  alternates: { canonical: 'https://clinicafacil.com.br/profissionais/dermatologia' },
};

const ABORDAGENS = ["Dermatologia Clínica","Dermatologia Estética","Dermatoscopia","Tratamento de Acne","Psoríase e Doenças Crônicas","Cirurgia Dermatológica","Cosmiatria","Onicologia/Unhas","Alopecia/Queda de Cabelo"];

export default async function Page() {
  let data: any = { profissionais: [], total: 0 };
  try {
  data = await api.professionals.search({ especialidade: 'Dermatologia', pagina: '1', tamanhoPagina: '20', ordem: 'relevancia' });
} catch {
  data = {
    total: 3,
    profissionais: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-rose-50 to-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Dermatologistas verificados</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Cuidados com a pele, cabelos e unhas. Dermatologistas com CRM validado. Online e presencial.</p>
        </div>
      </section>
