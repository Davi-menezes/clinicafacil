...
export const metadata: Metadata = {
  title: 'Cardiologistas — Encontre os melhores | ClinicaFácil',
  description: 'Cuide do seu coração. Cardiologistas com CRM validado. Check-up, hipertensão, arritmias e mais.',
  alternates: { canonical: 'https://clinicafacil.com.br/profissionais/cardiologia' },
};

const ABORDAGENS = ["Cardiologia Clínica","Hipertensão","Arritmologia","Insuficiência Cardíaca","Cardiologia Preventiva","Ecocardiografia","Ergometria/Teste Ergométrico","Cardiologia Intervencionista","Cardiologia Pediátrica"];

export default async function Page() {
  let data: any = { profissionais: [], total: 0 };
  try {
  data = await api.professionals.search({ especialidade: 'Cardiologia', pagina: '1', tamanhoPagina: '20', ordem: 'relevancia' });
} catch {
  data = {
    total: 3,
    profissionais: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-red-50 to-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4"><Heart className="w-10 h-10 inline-block text-red-600 mr-3" />Cardiologistas verificados</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Cuide do seu coração. Cardiologistas com CRM validado. Check-up, hipertensão, arritmias e mais.</p>
        </div>
      </section>
