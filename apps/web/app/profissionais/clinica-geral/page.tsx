...
export const metadata: Metadata = {
  title: 'Clínicos Gerais — Encontre os melhores | ClinicaFácil',
  description: 'Porta de entrada para sua saúde. Clínicos gerais para check-ups, prevenção e acompanhamento.',
  alternates: { canonical: 'https://clinicafacil.com.br/profissionais/clinica-geral' },
};

const ABORDAGENS = ["Medicina Preventiva","Check-up Completo","Acompanhamento de Doenças Crônicas","Saúde do Adulto","Saúde do Idoso","Medicina de Família","Saúde Ocupacional","Prescrição e Renovação de Medicamentos","Encaminhamento a Especialistas"];

export default async function Page() {
  let data: any = { profissionais: [], total: 0 };
  try {
  data = await api.professionals.search({ especialidade: 'Clínica Geral', pagina: '1', tamanhoPagina: '20', ordem: 'relevancia' });
} catch {
  data = {
    total: 3,
    profissionais: [
