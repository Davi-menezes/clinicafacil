      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary items-center justify-center p-12">
        <div className="max-w-md text-white">
          ...
          <p className="text-primary-foreground/80 text-lg">
            Acesse sua conta e continue cuidando da sua saúde ou gerenciando sua prática profissional.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h2 className="mt-6 text-2xl font-bold">Entrar na conta</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-3 py-2 border rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary/20 pr-10"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <button
              type="button"
              className="w-full py-2.5 border rounded-lg font-medium text-sm hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
            >
